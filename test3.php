...
if ($API->connect($ip, $user, $pass)) {
    ...
    print_r("-> Establecer zona horaria <-\n");
    ...
    if(enviaComando('/ip/neighbor/discovery/set', array('numbers'=>'ether1','discover'=>'no'))){
        print_r("Discovery no de ether1\n");
    }else{
                ...
                if (enviaComando('/interface/bridge/add', array("name"=>'bridge_trunk', 'protocol-mode'=>'none'))){
                    ...
                    if(count($READ) > 0){
                        if (!array_key_exists('!trap', $READ) && !array_key_exists('!trap', $READETHER)){
                            ...
                            else print_r("No se ha podido añadir comentario para ether2\n");
                            ...
                            if (strstr($READ[0]['model'],'941') > -1 || strstr($READ[0]['model'],'951') > -1 || strstr($READ[0]['model'],'952') > -1) {
                                ...
                                else print_r("No se ha podido añadir comentario para ether3\n");
                                
                                if (enviaComando('/interface/set', array('numbers'=>'ether4','comment'=>'ether4_trunk'))) print_r("comentario para ether4\n");
                                else print_r("No se ha podido añadir comentario para ether4\n");
                                ...
                                if (enviaComando('/interface/bridge/port/add', array('bridge'=>'bridge1_hs_clientes1','interface'=>'ether2'))){
                                    ...
                                    if (enviaComando('/interface/bridge/port/add', array('bridge'=>'bridge4_administracion','interface'=>'ether3'))){
                                        ...
                                        else print_r("No se ha podido deshabilitar el interface de admin\n");
                                            ...
                                            if (strstr($READ[0]['model'],'951') > -1 || strstr($READ[0]['model'],'952') > -1){
                                                ...
                                                if(enviaComando('/interface/set', array('numbers'=>'ether5','comment'=>'ether5_trunk'))) {
                                                    ...
                                                    if(enviaComando('/interface/disable', array('numbers'=>'ether5'))) {
                                                        ...
                                                        } else print_r("No se ha podido añadir ether5 a bridge_trunk\n");
                                                        
                                                    } else print_r("No se ha podido deshabilitar ether5\n");
                                                        
                                                } else print_r("No se ha podido comentar ether5\n");
                                            }
                                        }else print_r("No se ha podido añadir ether4 a bridge_trunk\n");
                                        
                                    }else print_r("No se ha podido añadir ether3 a bridge4_administracion\n");
                                    
                                }else print_r("No se ha podido añadir ether2 a bridge1_hs_clientes1\n");
                                ...
                                else print_r("No se ha podido añadir comentario para ether5\n");
                                            ...
                                            if (enviaComando('/interface/bridge/port/add', array('bridge'=>'bridge4_administracion','interface'=>'ether5'))) {
                                              print_r("ether5 añadido a bridge4_administracion\n"); 
                                                ...
                                                if (enviaComando('/interface/disable', array('numbers'=>'ether5'))){
                                                    ...
                                                    // } else {
                                                        if(enviaComando('/interface/set', array('numbers'=>$READETHER[$i]['name'],'comment'=>$READETHER[$i]['name'].'_trunk'))){
                                                            ...
                                                            if(enviaComando('/interface/bridge/port/add', array('bridge'=>'bridge_trunk','interface'=>$READETHER[$i]['name']))){
                                                              ...
                                                              print_r("No se ha podido añadir las ether trunik al bridge_trunk\n");
                                                            }
                                                        }else{
                                                            print_r("No se ha podido comentar las ether_trunk\n");
                                                        }
                                                    // }
                                                  ...
                                                  print_r("No se ha podido deshabilitar ether5\n");
                                                }
                                               
                                            } else print_r("No se ha podido añadir ether5 a bridge4_administracion\n");
                                           
                                        } else print_r("No se ha podido añadir ether4 a bridge3_staff\n");
                                       
                                    } else print_r("No se ha podido añadir ether3 a bridge2_hs_clientes2\n");
    ...
    if(enviaComando('/ip/firewall/layer7-protocol/add', array("name"=>"facebook","regexp"=>"^.+(facebook.com).*\$"))){
        ...
        print_r("layer7-protocol no se ha añadido\n"); 
    }
    ...
    // if(enviaComando('/ip/dhcp-client/add', array('dhcp-options'=>'hostname,clientid','disabled'=>'no','interface'=>'ether1'))){
    //     print_r("Se ha añadido DHCP client a ether1\n");
    // }else print_r("No se ha podido añadir DHCP client a ether1\n");
    ...
    }else print_r("No se ha podido añadir filter rule FB Port Knocking 3min access window\n"); 
    ...
    }else print_r("No se ha podido añadir filter rule FB Block no auth customers\n");
    ...
    }else print_r("No se ha podido añadir filter rule place hotspot rules here\n");
    ...
    }else print_r("No se ha podido añadir mangle rule FB Connection Mark\n");
    ...
    }else print_r("No se ha podido añadir nat rule place hotspot rules here\n");
    ...
    // }else print_r("No se ha podido añadir nat rule masquerade hotspot network\n");
    ...
    }else print_r("No se ha podido añadir nat rule masquerade Drop conexiones https cuando unAuth\n");
    ...
    }else print_r("No se ha podido añadir www.thinkdifferent.us\n");
    ...
    }else print_r("No se ha podido añadir walled garden ip\n");
    ...
    }else print_r("No se ha podido hacer fetch de alogin.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de averia.jpg\n");
    ...
    }else print_r("No se ha podido hacer fetch de error.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de errors.txt\n");
    ...
    }else print_r("No se ha podido hacer fetch de interneterror.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de GETSERIALNAME-login.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de logoservibyte.png\n");
    ...
    }else print_r("No se ha podido hacer fetch de logout.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de md5.js\n");
    ...
    }else print_r("No se ha podido hacer fetch de radvert.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de redirect.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de rlogin.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de status.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de testinternet.txt\n");
    ...
    }else print_r("No se ha podido hacer fetch de logobottom.png\n");
    ...
    }else print_r("No se ha podido hacer fetch de lv/alogin.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de lv/errors.txt\n");
    ...
    }else print_r("No se ha podido hacer fetch de /lv/login.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de lv/logout.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de lv/radvert.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de lv/status.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de xml/alogin.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de xml/error.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de xml/flogout.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de xml/login.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de xml/logout.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de xml/rlogin.html\n");
    ...
    }else print_r("No se ha podido hacer fetch de xml/WISPAccessGatewayParam.xsd\n");
    ...
    }else print_r("No se ha podido añadir note\n");
    ...
    }else print_r("No se ha podido establecer protected-routerboot\n");
    ...
    if(enviaComando('/system/script/add', array("name"=> "testinternet", "owner"=> "administrador", "policy"=>"ftp,reboot,read,write,policy,test,password,sniff,sensitive", "source"=>":global internetactivo;\r if (\$internetactivo!=0 && \$internetactivo!=1) do={\r:set internetactivo 0;:log error \"Comienza Test Internet\";/file print file=\$myfile; /file set \$file contents=\"interneterror.html\";/ip dns static enable [find comment~\"Capturador\"]}:local myfile \"hotspot/testinternet\";:local file (\$myfile);:local pingresultado [/ping 4.2.2.4 count=5];:if (\$pingresultado>0) do={:if (\$internetactivo=0) do={:log error \"Internet funcionando\";:set internetactivo 1;/file print file=\$myfile /file set \$file contents=\"https:wifipremium.com/login.php\";/ip dns static disable [find comment~\"Capturador\"] } :if (\$pingresultado=0) do={:if (\$internetactivo=1) do={:log error \"Internet caido\";:set internetactivo 0;/file print file=\$myfile /file set \$file contents=\"interneterror.html\"; /ip dns static enable [find comment~\"Capturador\"] }}"))){
        ...
        }else print_r("No se ha podido Script testinternet scheduled\n");
    }else print_r("no se ha podido añadir script testinternet\n");
    ...
    if(enviaComando('/system/script/add', array("name"=> "hotspot", "owner"=> "administrador", "policy"=>"ftp,reboot,read,write,policy,test,password,sniff,sensitive", "source"=>"execute \"/tool fetch mode=http address=checkip.dyndns.org src-path=/ dst-path=d yndns.checkip.html\" :local result [/file get dyndns.checkip.html contents] :local resultLen [:len \$result] :local startLoc [:find \$result \": \" -1] :set startLoc (\$startLoc + 2) :local endLoc [:find \$result \"</body>\" -1] :local currentIP [:pick \$result \$startLoc \$endLoc] { :local activo 0; :foreach i in=[/system logging find] do={ :if ([/system logging get \$i topics]=\"firewall\") do={ :set activo 1 } }; :log warning (\":coronablanca::hotspot::up:\" . [/system resource get uptime] . \";cpu-load:\" . [/system resource get cpu-load] . \";active:\" . [/ip hotspot active print count-only]  . \";trazabilidad:\" . \$activo. \";ip:\" . \$currentIP)}"))){
        ...
        }else print_r("no se ha podido añadir script hotspot\n");
    }else print_r("no se ha podido añadir script hotspot\n");
    ...
    }else print_r("no se ha podido añadir script Ap10\n");
    ...
    }else print_r("no se ha podido añadir script Ap11\n");
    ...
    }else print_r("no se ha podido añadir script Ap12\n");
    ...
    }else print_r("No se ha podido añadir delete_user_test\n");
    ...
    }else print_r("No se ha podido añadir find_no_more_sessions_test\n");
    ...
    }else print_r("No se ha podido añadir genera_no_more_sessions\n");
...
function enviaComando($comando, $opciones){
    ...
    // if(){
        ...
        if (!empty($res) && /*gettype($res) == 'Array' &&*/ array_key_exists ('!trap',$res)){
            ...
            //     $res = $API->comm($comando);
            // }
            if (!empty($res) && array_key_exists ('!trap',$res)){
