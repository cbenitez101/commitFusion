    							    ...
    							    <div class="row">
    							        ...
    							        <div class="col-md-6">
    									    ...
    									    <div class="tooltip-demo form-group">
                                                ...
                                                <input class="form-control perfil-15" name="formato" id="modal_perfilformato" data-toggle="tooltip" data-placement="left" title="'T': Todos, 'A': Alfabeto, 'M': Mayúsculas, 'm': Minusculas, 'N': Números, 'b': minúsculas y números, 'B': Mayúsculas y números, 'V': Vocales mayúsculas, 'v': Vocales minúsculas, 'C': Consonantes mayúsculas, 'c': consonantes minúsculas. Si se deja en blanco se generará con el siguiente formato: CVCVCVNN.">
                                            
                                            	<label>Formato Contraseña</label>
        										<input class="form-control perfil-16" name="password" id="modal_perfilpassword" data-toggle="tooltip" data-placement="left" title="'T': Todos, 'A': Alfabeto, 'M': Mayúsculas, 'm': Minusculas, 'N': Números, 'b': minúsculas y números, 'B': Mayúsculas y números, 'V': Vocales mayúsculas, 'v': Vocales minúsculas, 'C': Consonantes mayúsculas, 'c': consonantes minúsculas. 'Usuario': utiliza el nombre de usuario como password. Si se deja en blanco se generará con con el siguiente formato: CVCVCVNN.">
