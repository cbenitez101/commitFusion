...
{*<div class="float_left">*}
    {*{html_table cols=$cols  table_attr='border="0" class="tabledit bloctable" id="table-search-bloc"' loop=$bloc}*}
{*</div>*}
{*{if isset($excel)}*}
    {*<script>window.location='http://servibyte.net/bloc_excel?bloc={$excel}';</script>*}
{*{/if}*}
